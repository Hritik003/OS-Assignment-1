...
void customer_order(int i,int *ordersarr){
...
int main(){
    ...
    for(int i=0;i<shmptr[1]+2;i++){
        printf("%d ",shmptr[i]);
    }
    printf("\n");
    sleep(10);
    if(shmptr[0]!= -404)printf("The bill amount is: %d INR\n",shmptr[0]);
    else {
